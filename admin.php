...
<body class="sb-nav-fixed">
                        ...
                        <div class="users-table">
                            <div class="col-xl-16 col-md-16">
                                ...
                                <div class="align-night mt-1">
                                    <a href="admin_exportar_excel.php" class="btn btn-success" onclick="return exportarExcel()"><i class="fas fa-file-excel"></i> Exportar a Excel</a>
                                </div>
                                <div class="align-night mt-2">
                                    <a href="admin_exportar_pdf.php" class="btn btn-danger" onclick="return exportarPdf()"><i class="fas fa-file-pdf"></i> Exportar a pdf</a>
                                </div>
                                        ...
                                        <tbody class="text-center">
                                            <?php while ($row = mysqli_fetch_array($query)) : ?>
                                                <tr>
                                                    ...
                                                    <td>
                                                        <a href="admin_editar.php?id_contacto=<?= $row['id_contacto'] ?>" class="btn btn-primary">Editar</a>
                                                    </td>
                                                    <td>
    ...
    <script>
        function ConfirmarEliminacion(id_contacto) {
            ...
            if (confirmar) {
                return window.location.href = "admin_eliminar.php?id_contacto=" + id_contacto;
            } else {
                return false;
            }
        }
