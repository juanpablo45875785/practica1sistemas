...
if (
...

 {
    ...
    $verif = "SELECT * FROM tbl_contacto WHERE telefono_1= '$telefono1'";// or si hay algun registro no repetible
    ...
    if (mysqli_num_rows($resultado) > 0) {
        header('Location: admin.php?error=nombre_cont_apellido_cont_existente');
        exit;
    } else {
