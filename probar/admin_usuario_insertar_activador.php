...
if (
    isset($_POST['nombre_cont'], $_POST['apellido_cont'], $_POST['cod_car_1'], $_POST['cod_car_2'], $_POST['telefono_1'], $_POST['telefono_2'], $_POST['propietario_cont'], $_POST['cod_origen_dato'], $_POST['cod_estado_cont'], $_POST['descripcion_cont'])
    ...
    && !empty($_POST['cod_estado_cont']) && !empty($_POST['descripcion_cont'])) {
    ...
    $sql = "INSERT INTO tbl_contacto (nombre_cont, apellido_cont, cod_car_1, cod_car_2, telefono_1, telefono_2, propietario_cont, cod_origen_dato, cod_estado_cont, descripcion_cont) VALUES ('$nombre', '$apellido', '$codigo1', '$codigo2', '$telefono1', '$telefono2', '$propietario', '$origen', '$codigoestado', '$descripcion')";
    ...
    header("Location: admin_usuario_insertar.php?error=datos_incompletos");
    exit;
}
