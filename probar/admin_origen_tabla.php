...
if (isset($_GET['buscar']) && !empty($_GET['buscar'])) {
    ...
    $sql = "SELECT * FROM origen_contacto WHERE  nombre_orig LIKE ? ";
    ...
    $sql = "SELECT * FROM origen_contacto WHERE estado_orig= 1";
...
<body class="sb-nav-fixed">
        ...
        <div id="layoutSidenav_content">
            <main>
                ...
                <table class="table table-success  table-striped table-bordered table-hover table-sm border-primary" id="DataTable">
                                        <div class="card-body">
                                            <h1 class="text-center">ORIGEN DATOS</h1>
                                            <br>
                                            ...
                                            <tbody class="text-center">
                                                <?php while ($row = mysqli_fetch_assoc($query)) : ?>
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <a href="admin_origen_editar.php?id_orig=<?= $row['id_orig'] ?>" class="btn btn-primary">Editar</a>
                                                        </td>
                                                        <td>
                                                            <a class="btn btn-danger" onclick="ConfirmarEliminacion(<?= $row['id_car'] ?>)">Eliminar</a>
                                                        </td>
                                                        <td>
                                                            <a href="admin_agregar_carrera.php" class="btn btn-success">Agregar</a>
                                                        </td>
    ...
    <script>
        function ConfirmarEliminacion(id_contacto) {
            ...
            if (confirmar) {
                return window.location.href = "admin_eliminar_carrera.php?id_car=" + id_contacto;
            } else {
                return false;
            }
        }
